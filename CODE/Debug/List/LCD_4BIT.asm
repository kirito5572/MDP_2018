...
_0x0:
	.DB  0x41,0x54,0x4D,0x45,0x47,0x41,0x20,0x31
	.DB  0x32,0x38,0x0,0x4B,0x49,0x4D,0x20,0x48
	.DB  0x59,0x45,0x4F,0x4B,0x4A,0x49,0x4E,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0013     lcd_clear();
	RCALL _lcd_clear
; 0000 0014     lcd_gotoxy(3,0);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0015     lcd_putsf("ATMEGA 128");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 0016     lcd_gotoxy(3,1);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 0017     lcd_putsf("KIM HYEOKJIN");
	__POINTW2FN _0x0,11
	RCALL _lcd_putsf
; 0000 0018 
; 0000 0019 
